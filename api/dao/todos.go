...
type Todo struct {
	...
	UsersID      int64     `boil:"users_id" json:"users_id" toml:"users_id" yaml:"users_id"`
...
var (
	todoColumns               = []string{"id", "users_id", "description", "is_done", "registered_at"}
	todoColumnsWithoutDefault = []string{"users_id", "description", "is_done", "registered_at"}
...
func (o *Todo) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("dao: no todos provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("dao: unable to upsert todos, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "dao: unable to upsert todos")
	}
...
func (o TodoSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("dao: no Todo slice provided for delete all")
	}
